          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
								...
								<tbody>
								<?php json_encode($filter); ?>
								<?php if($dataList) :
								$x=1;
								foreach($dataList['result_qc_hasil'] as $item) {
									$linkUrl = ($filter=="5") ? "#": base_url('Dashboard1/petasuara/?filter=' . ($filter) . '&kd_filter='. ($item['kd_kel']));

									$item['url'] = ($filter=="5") ? $item['nama'] : '<a href="'.$linkUrl.'">'.$item['nama'].'</a>';
